...
CSRF_TRUSTED_ORIGINS = ["https://smsapi-production-b762.up.railway.app"]

# For local deployment using NGROK
# CSRF_TRUSTED_ORIGINS = ["https://b359-102-176-65-15.ngrok-free.app"]
...
WSGI_APPLICATION = "smscore.wsgi.application"
